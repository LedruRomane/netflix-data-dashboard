...
def normalize_df(df):
    ...
    production_countries_list = {production_countries_list[i]: i for i in range(0, len(production_countries_list))}
    df['production_countries'] = df['production_countries'].map(production_countries_list)
